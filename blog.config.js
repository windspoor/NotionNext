...
const BLOG = {
  AUTHOR: 'lin', // 作者
  BIO: '乾坤未定，你我皆黑马', // 作者简介
  LINK: 'https://102451.xyz', // 网站地址
  KEYWORDS: '生活, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  ...
  CONTACT_EMAIL: 'linqifei2021@163.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: '',
  CONTACT_TELEGRAM: '',
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-9LCK5012FV', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
